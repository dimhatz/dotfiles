...
# ddd modified colors to apply the exact original solarized xterm palette.
# This script is used only for the procedure of applying so that can be done
# without relying on .Xresources (the xresources way means restarting xterm
# when changing themes).
# P.S. only 16 colors and cursor color are needed. The rest are deleted.
...
color14="93/a1/a1"
color15="fd/f6/e3"
color_foreground=$color12
color_background=$color08
